  ...
  if (!result.success) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <h2 className="font-display text-2xl font-bold text-content">Something went wrong</h2>
        <p className="mt-2 max-w-sm text-sm text-content-secondary">{result.error}</p>
  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <h2 className="font-display text-2xl font-bold text-content">Your cart is empty</h2>
        <p className="mt-2 max-w-sm text-sm text-content-secondary">Add some jerseys before checking out.</p>
        <Link href="/shop" className="mt-8 inline-flex rounded-lg border border-green-400/20 bg-green-400/10 px-4 py-2.5 text-sm font-semibold text-green-400 transition-all duration-300 hover:bg-green-400/20">
